...
<h3 class="mt-4">Shades of base colors</h3>

<p>For certain work, graphic work, more advanced illustrations or graphs some of base colors can be toned for the purpose. This also goes for making graphs in PowerPoint or other output that need multiple different colors to work.</p>

<p>Below the accepted shadings are outlined for the base colors:</p>
...
<h3 class="mt-4">Standard text colors</h3>
...
<div class="px-1">
  <div class="md:flex md:-mx-1">
    ...
    <div class="w-1/2 px-1">
      <div class="bg-white p-4 text-center rounded border-2 border-grey">
        <p class="text-purple-darker">
          <strong class="text-purple-darker">Secoundary text</strong><br>
          "white"<br>
          #ffffff<br>
          rgb(255,255,255)
        </p>
...
<h3 class="mt-8">UI support colors</h3>

<p>In some cases we need to use certain colors in order to give the users the best possible UX / UI. </p> 
